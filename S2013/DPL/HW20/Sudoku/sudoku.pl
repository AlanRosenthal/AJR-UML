...
sudoku(Solution, Puzzle) :-
    ...
    valid([Row1,Row2,Row3,Row4,Row5,Row6,Row7,Row8,Row9,Col1,Col2,Col3,Col4,Col5,Col6,Col7,Col8,Col9,Squ1,Squ2,Squ3,Squ4,Squ5,Squ6,Squ7,Squ8,Squ9]).
    
%   [8, _, _, 9, _, _, 1, 5, _, 7, 1, _, _, 5, _, _, _, 4, 4, _, 6, _, _, _, 7, 9, _, _, 7, 4, _, 1, _, 3, _, 2, _, _, _, 7, _, 2, _, _, _,9, _, 2, _, 8, _, 6, 1, _,_, 4, 8, _, _, _, 5, _, 1,2, _, _, _, 6, _, _, 7, 8,_, 6, 7, _, _, 8, _, _, 9]
